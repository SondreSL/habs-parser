...
instance Print PureExp where
  prt i e = case e of
    ...
    ELet formalpar pureexp1 pureexp2 -> prPrec i 7 (concatD [doc (showString "let"), doc (showString "("), prt 0 formalpar, doc (showString ")"), doc (showString "="), prt 0 pureexp1, doc (showString "in"), prt 0 pureexp2])
    EIf pureexp1 pureexp2 pureexp3 -> prPrec i 7 (concatD [doc (showString "if"), prt 0 pureexp1, doc (showString "then"), prt 0 pureexp2, doc (showString "else"), prt 0 pureexp3])
    ECase pureexp ecasebranchs -> prPrec i 7 (concatD [doc (showString "case"), prt 0 pureexp, doc (showString "{"), prt 0 ecasebranchs, doc (showString "}")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
